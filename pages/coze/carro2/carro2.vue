...
export default {
  ...
  middleware ({ redirect }) {
    console.log('middleware carro2 redirecting to coze.com.br')
    return redirect('https://coze.com.br');
  },

  async asyncData ({ store, params, query, route, req, error, redirect }) {
    console.log('carro2.vue async data params.pending:', params.pending)
    console.log('carro2.vue async data => route.path:', route.path)
